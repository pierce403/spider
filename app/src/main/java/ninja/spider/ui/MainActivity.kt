...
import ninja.spider.R
import ninja.spider.databinding.ActivityMainBinding
import ninja.spider.sdr.SdrPreferences
import ninja.spider.sdr.SdrState
import ninja.spider.sdr.SdrUsbDetector
import ninja.spider.util.AppVersion
import ninja.spider.util.AppVersionInfo
...
class MainActivity : AppCompatActivity() {
  ...
  override fun onStart() {
    super.onStart()
    (application as ninja.spider.SpiderApp).sdrController.registerUsbDetection()
    updateUsbSummary()
  }

  override fun onStop() {
    (application as ninja.spider.SpiderApp).sdrController.unregisterUsbDetection()
    viewModel.stopScan()
    super.onStop()
  }
